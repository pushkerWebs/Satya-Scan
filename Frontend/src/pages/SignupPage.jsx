    ...
    >
      ...
      >
        <svg width="100" height="100" viewBox="0 0 100 100" fill="none">
          <defs>
            <linearGradient id="shieldGradSignup" x1="0" y1="0" x2="100" y2="100" gradientUnits="userSpaceOnUse">
              <stop offset="0%" stopColor="#14B8A6" />
              <stop offset="100%" stopColor="#5eead4" />
            </linearGradient>
            <filter id="shieldGlowSignup">
              <feGaussianBlur stdDeviation="4" result="coloredBlur" />
              <feMerge><feMergeNode in="coloredBlur" /><feMergeNode in="SourceGraphic" /></feMerge>
            </filter>
          </defs>
          <path d="M50 6 L88 22 L88 54 C88 72 70 88 50 95 C30 88 12 72 12 54 L12 22 Z"
            fill="url(#shieldGradSignup)" opacity="0.15" stroke="url(#shieldGradSignup)" strokeWidth="1.5" />
          <text x="50" y="64" textAnchor="middle" fontSize="40" fontWeight="800"
            fontFamily="Inter,Arial,sans-serif" fill="url(#shieldGradSignup)" filter="url(#shieldGlowSignup)">S</text>
        </svg>
      </motion.div>
    </motion.div>
  );
...
function getPasswordStrength(pw) {
  ...
  if (score === 3) return { level: 70, label: 'Good', color: '#14B8A6' };
    ...
    <div className="min-h-screen flex" style={{ background: '#09090B' }}>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label className="text-[11px] font-semibold uppercase tracking-wider mb-2 block"
                  style={{ color: 'rgba(209,213,219,0.4)' }}>{t('signup.name')}</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 rounded-xl text-sm text-white placeholder:text-white/20 outline-none transition-all duration-200"
                    style={{
              ...
              <div>
                <label className="text-[11px] font-semibold uppercase tracking-wider mb-2 block"
                  style={{ color: 'rgba(209,213,219,0.4)' }}>{t('signup.email')}</label>
                <div className="relative">
              ...
              <div>
                <label className="text-[11px] font-semibold uppercase tracking-wider mb-2 block"
                  style={{ color: 'rgba(209,213,219,0.4)' }}>{t('signup.password')}</label>
                <div className="relative">
          ...
          <motion.p custom={3} variants={fadeUp} initial="hidden" animate="visible"
            ...
            {t('signup.hasAccount')}{' '}
            <Link to="/login" className="font-semibold hover:underline" style={{ color: '#14B8A6' }}>
              {t('signup.loginLink')}
            </Link>
          </motion.p>
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center relative overflow-hidden"
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-12 max-w-sm">
          ...
          >
            Join <span style={{ color: '#14B8A6' }}>Satya</span>Scan
          </motion.h2>
